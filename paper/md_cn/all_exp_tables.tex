...
\caption{主 biological benchmark 结果。单元格为五折 mean $\pm$ std [min, max]。加粗表示该数据集上的最佳均值。}
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\caption{补充鲁棒性 benchmark 结果。单元格为五折 mean $\pm$ std [min, max]。加粗表示该数据集上的最佳均值。}
...
\centering
\footnotesize
\caption{各数据集优胜模型摘要，并给出最大/最小折准确率。}
\label{tab:all_winners}
\begin{tabular}{l l c c c}
\toprule
数据集 & 优胜模型 & 平均准确率 & 最大准确率 & 最小准确率 \\
\midrule
