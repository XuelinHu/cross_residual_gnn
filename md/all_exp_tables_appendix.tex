\begin{center}
\small
\captionof{table}{Main biological benchmark results. Numbers are mean best test accuracy $\pm$ standard deviation.}
\begin{tabular}{lccc}
\toprule
...
\begin{center}
\small
\captionof{table}{Supplementary robustness benchmark results.}
\begin{tabular}{lccc}
\toprule
...
\begin{center}
\small
\captionof{table}{Winner summary, optimization depth, and parameter count for each dataset.}
